...
public class 로또의최고순위와최저순위 {
  ...
  public void test1(){
    ...
    int[] expected = {3, 5};
    Assert.assertArrayEquals(solution(lottos, winNums), expected);
  }
  @Test
  public void test2(){
  ...
  public int[] solution(int[] lottos, int[] winNums) {
    ...
    for (int win: winNums) {
      if (map.containsKey(win)) matchedCount++;
    }

    return new int[]{getRank(matchedCount + zeroCount), getRank(matchedCount)};
  }
